...
%
%   For proper scaling, the function ekf.CHI2INVTABLE is employed to
...
%
%   See also DRAWELLIPSE, ekf.CHI2INVTABLE, CHI2INV.
...
a = a*sqrt(ekf.chi2invtable(alpha,2));
b = b*sqrt(ekf.chi2invtable(alpha,2));
